...
function onDownloaded(asset) {
    ...
    } catch (e) { Studio.log("onDownloaded exception: " + e); }
}
...
upd.bind(function () {
    ...
    } catch (e) { Studio.log("Update exception: " + e); }
});
